...
import ExcileFileUtilities.PropertyFileUtil;
...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser() throws Exception{
		...
		if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("chrome")){
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\madhuch\\Desktop\\Madhu80\\StockAccountingHybrid\\drivers\\chromedriver.exe");
		    driver=new ChromeDriver();
		}else if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox")){
			System.setProperty("webdriver.gecko.driver", "C:\\Users\\madhuch\\Desktop\\Madhu80\\StockAccountingHybrid\\drivers\\geckodriver.exe");
			driver=new FirefoxDriver();
		}else if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("ie")){
			System.setProperty("webdriver.internetexplorer.driver", "C:\\Users\\madhuch\\Desktop\\Madhu80\\StockAccountingHybrid\\drivers\\IEDriverServer.exe");
	...
	public static void captureData(WebDriver driver,String locatortytpe,
		...
		FileWriter fw=new FileWriter("C:\\Users\\madhuch\\Desktop\\Madhu80\\StockAccountingHybrid\\CaptureData\\suppnumber.txt");
	...
	public static void tableValidation(WebDriver driver,String column) throws Exception{
		FileReader fr=new FileReader("C:\\Users\\madhuch\\Desktop\\Madhu80\\StockAccountingHybrid\\CaptureData\\suppnumber.txt");
